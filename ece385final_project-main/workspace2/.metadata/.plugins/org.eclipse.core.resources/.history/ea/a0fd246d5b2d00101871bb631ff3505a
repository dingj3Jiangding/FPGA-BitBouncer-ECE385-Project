...
void draw_game_victory(BRAM_t* hdmi_ctrl){
	// Calculate center position for "VICTORY!"
	// Total width = 8 characters including !
	int total_width = 8 * CHAR_WIDTH;
	int start_x = (SCREEN_WIDTH - total_width) / 2;
	int start_y = (SCREEN_HEIGHT - CHAR_HEIGHT) / 2;  // Center vertically

	// Draw "VICTORY!" centered on screen
	draw_chrarcter(start_x, start_y, CHAR_V, hdmi_ctrl);                             // V
	draw_chrarcter(start_x + CHAR_WIDTH, start_y, CHAR_I, hdmi_ctrl);               // I
	draw_chrarcter(start_x + CHAR_WIDTH * 2, start_y, CHAR_C, hdmi_ctrl);           // C
	draw_chrarcter(start_x + CHAR_WIDTH * 3, start_y, CHAR_T, hdmi_ctrl);           // T
	draw_chrarcter(start_x + CHAR_WIDTH * 4, start_y, CHAR_O, hdmi_ctrl);           // O
	draw_chrarcter(start_x + CHAR_WIDTH * 5, start_y, CHAR_R, hdmi_ctrl);           // R
	draw_chrarcter(start_x + CHAR_WIDTH * 6, start_y, CHAR_Y, hdmi_ctrl);           // Y
	draw_chrarcter(start_x + CHAR_WIDTH * 7, start_y, CHAR_SUPRISE, hdmi_ctrl);     // !
}
