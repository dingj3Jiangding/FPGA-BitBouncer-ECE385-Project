...
HD_PWD='D:/ZJUI/ECE385/labs/final/final_project/final_project.runs/mb_lab7_axi_gpio_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_lab7_axi_gpio_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_lab7_axi_gpio_0_1.tcl
